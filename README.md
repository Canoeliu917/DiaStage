...
[用户指南：UE5 标准置景操作](USER_GUIDE.md)统一采用 UE5.6 默认关卡编辑器规格，覆盖观察、变换、支点、吸附和编组。编辑器设置中的“用户指南与快捷键”提供标准操作与方块练习。运行时尚待适配，差异及 [Codex 实施说明](docs/UE5_CONTROLS_IMPLEMENTATION.md)均已列出。
