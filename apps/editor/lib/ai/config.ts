...
export const THEATRE_TRANSCRIPTION_PROMPT =
  '戏剧排练与舞台置景口令。专业词：舞台、台口、台左、台右、台前、台后、上场口、下场口、舞台中区、前区、后区、景片、门景片、窗景片、台阶、平台、沙发、桌椅、圆桌、镜头、机位、米、厘米、毫米、相邻、紧挨、对齐、间距、移动、旋转、缩放、复制、删除、复台、排演、置景。台左和台右以演员面向观众为准，不能替换为观众左或右。忠实转写，不补充未说出的内容。'
