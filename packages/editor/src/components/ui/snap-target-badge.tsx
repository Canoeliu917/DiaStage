...
export function SnapTargetIcon({ children, target }: { children: ReactNode; target: SnapTarget }) {
  return (
    <span className="relative inline-flex h-5 w-5 items-center justify-center">
      {children}
      <SnapTargetBadge className="-right-1.5 -bottom-1.5 absolute" size="tree" target={target} />
    </span>
  )
}
