...
export function PluginsPanel() {
      ...
      <div className="flex h-full flex-col overflow-y-auto p-4">
        <div>
          ...
          <dl className="mt-6 divide-y divide-border/50 rounded-xl border border-border/60">
            ...
            {panel.pluginUrl && (
              <div className="p-3">
                <dt className="text-sidebar-foreground/50 text-xs">插件</dt>
                <dd className="mt-1 text-sm">
                  <a
                    className="inline-flex items-center gap-1 text-sidebar-foreground underline-offset-4 hover:underline"
  ...
  return (
    <div className="flex h-full flex-col overflow-y-auto p-4">
      <div className="mb-5">
        <h2 className="font-semibold text-lg text-sidebar-foreground">插件</h2>
        <p className="mt-1 text-sidebar-foreground/60 text-sm">为项目添加专用工具和内容。</p>
      </div>
