    ...
    <div className="flex flex-col gap-6 p-3">
      {projectId && (
        <div className="space-y-2">
          <label className="font-medium text-muted-foreground text-xs uppercase">项目</label>
          <div className="font-medium text-sm">项目 ID</div>
          <div className="flex items-center gap-2">
            <Input aria-label="项目 ID" className="font-mono text-xs" readOnly value={projectId} />
            <Button
              aria-label={projectIdCopyState === 'copied' ? '已复制项目 ID' : '复制项目 ID'}
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground text-xs">
                {projectVisibility?.isPrivate ? '仅你' : '任何人'} 可以查看
              </div>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-muted-foreground text-xs">向公开访问者显示</div>
            </div>
            <Switch
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="font-medium text-sm">阴影</div>
              <div className="text-muted-foreground text-xs">灯光投射阴影</div>
            </div>
            <Switch
              checked={shadows}
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          <div className="font-medium text-muted-foreground text-xs">三维模型</div>
          <div className="flex items-center justify-between gap-4 rounded-md border p-3">
            <div>
              <div className="font-medium text-sm">仅可见节点</div>
              <div className="text-muted-foreground text-xs">不包含隐藏的家具及其他场景节点</div>
            </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between font-medium text-muted-foreground text-xs">
            <span>平面图</span>
            <span>{floorplanMode === 'default' ? '默认模式' : '专家模式'}</span>
          </div>
          <Button
            className="w-full justify-start gap-2"
      ...
      {projectId && !isLocalProject && (
        <div className="space-y-2">
          ...
          >
            ...
            {isGeneratingThumbnail ? '正在生成…' : '生成缩略图'}
          </Button>
        </div>
      )}
      ...
      {/* Danger Zone */}
      <div className="space-y-2">
        <label className="font-medium text-destructive text-xs uppercase">高风险操作</label>
