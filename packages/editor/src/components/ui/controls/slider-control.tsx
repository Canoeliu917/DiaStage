...
export function SliderControl({
  ...
  return (
    <div
      className={cn(
        'group flex min-h-7 w-full select-none items-center gap-2 rounded-lg px-2 py-1 transition-colors',
    ...
    >
      ...
      <div
        className={cn(
          'flex min-w-0 flex-1 cursor-ew-resize items-center gap-1.5 text-xs transition-colors',
      ...
      >
        ...
        <div
          className={cn(
            'grid shrink-0 grid-cols-2 gap-[2.5px] transition-opacity',
      ...
      <div className="flex shrink-0 items-center text-xs">
        {isEditing ? (
          ...
          >
            <span className="font-mono tracking-tight">多种值</span>
          </div>
        ) : (
          <div
