...
export const ZoneNode = BaseNode.extend({
  ...
  // Read-only compatibility for scenes that stored wall-generated rooms.
  autoFromWalls: z.boolean().optional(),
  boundaryWallIds: z.array(objectId('wall')).optional(),
  // Visual styling
  ...
  - autoFromWalls, boundaryWallIds: legacy compatibility only
