...
> = {
  skirting: [
    { label: '平面', value: 'flat' },
    { label: '现代', value: 'base-modern' },
    { label: '殖民地式', value: 'base-colonial' },
    { label: '鞋形', value: 'base-shoe' },
    { label: '反曲线', value: 'base-ogee' },
  ],
  crown: [
    { label: '平面', value: 'flat' },
    { label: '凹弧', value: 'crown-cove' },
    { label: '反曲线', value: 'crown-ogee' },
    { label: '工艺式', value: 'crown-craftsman' },
    { label: '层叠', value: 'crown-layered' },
  ],
  chairRail: [
    { label: '平面', value: 'flat' },
    { label: '圆形', value: 'rail-rounded' },
    { label: '反曲线', value: 'rail-ogee' },
    { label: '画框式', value: 'rail-picture' },
    { label: '阶梯', value: 'rail-stepped' },
  ],
}
      ...
      <PanelSection title="尺寸">
        ...
        {isPlaneBound ? (
          <div className="px-1 text-[11px] text-muted-foreground">
            当前 {formatLinearMeasurement(height, unit)}
          </div>
        ) : (
          <SliderControl
            label="高度"
...
function WallTrimSection({
  ...
  return (
    <PanelSection title={title}>
      <ActionGroup>
        <ActionButton
          label={trimValue.enabled ? `隐藏${title.toLowerCase()}` : `显示${title.toLowerCase()}`}
      ...
      {trimValue.enabled && (
        <>
          <SegmentedControl
            ...
            options={[
              { label: '内侧', value: 'interior' },
              { label: '外侧', value: 'exterior' },
              { label: '两侧', value: 'both' },
            ]}
