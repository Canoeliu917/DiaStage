...
const DOOR_STYLE_OPTIONS: Array<{
  ...
  { label: '中分', value: 'center-opening' },
  { label: '单扇向左', value: 'single-left' },
  { label: '单扇向右', value: 'single-right' },
]
...
const DOOR_PANEL_STYLE_OPTIONS: Array<{
  ...
  { label: '玻璃框架', value: 'glass-frame' },
  { label: '实心面板', value: 'solid-panel' },
  { label: '分段面板', value: 'segmented-panel' },
]
            ...
            return (
              ...
              >
                <span className="flex min-w-0 flex-col">
                  <span className="truncate text-xs">{level.name || `楼层 ${level.level}`}</span>
                  {isDisabled ? (
