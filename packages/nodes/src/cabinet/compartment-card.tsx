...
const COMPARTMENT_TYPE_OPTIONS = [
  { value: 'shelf', label: '搁板' },
  { value: 'drawer', label: '抽屉' },
  { value: 'door', label: '门' },
  { value: 'oven', label: '烤箱' },
  { value: 'microwave', label: '微波炉' },
  { value: 'dishwasher', label: '洗碗机' },
  { value: 'cooktop', label: '灶台' },
  { value: 'sink', label: '水槽' },
  { value: 'pull-out-pantry', label: '拉篮' },
] as const

const FRIDGE_TYPE_OPTION = { value: 'fridge', label: '冰箱' } as const
const HOOD_TYPE_OPTION = { value: 'hood', label: '抽油烟机' } as const
...
const FRIDGE_STYLE_OPTIONS = [
  { value: 'fridge-single', label: '单门' },
  { value: 'fridge-double', label: '双门' },
  { value: 'fridge-top-freezer', label: '上置冷冻室' },
  { value: 'fridge-bottom-freezer', label: '下置冷冻室' },
] as const

const COOKTOP_STYLE_OPTIONS = [
  { value: 'cooktop-gas', label: '燃气' },
  { value: 'cooktop-induction', label: '电磁' },
] as const
...
const SINK_LAYOUT_OPTIONS = [
  { value: 'single', label: '单槽' },
  { value: 'double', label: '双槽' },
