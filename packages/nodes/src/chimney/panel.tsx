...
const CHIMNEY_TYPE_OPTIONS: Array<{ label: string; value: ChimneyType }> = [
  { label: '罩帽', value: 'cap' },
  { label: '烟道', value: 'flues' },
  { label: '收肩', value: 'shoulder' },
  { label: '装饰带', value: 'bands' },
  { label: '分水坡', value: 'cricket' },
  { label: '面板', value: 'panels' },
]
  ...
  return (
    ...
    >
      ...
      <PanelSection title="平面轮廓">
        ...
        />
        <SliderControl
          label={(node.bodyShape ?? 'square') === 'round' ? '直径' : '宽度'}
          max={1000}
          min={0.2}
        ...
        {chimneyType === 'cap' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: '无', value: 'none' },
                { label: '斜面', value: 'sloped' },
                { label: '平面', value: 'flat' },
                { label: '阶梯形', value: 'stepped' },
              ]}
        ...
        {chimneyType === 'shoulder' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: '无', value: 'none' },
                { label: '渐缩', value: 'tapered' },
                { label: '叠涩', value: 'corbeled' },
              ]}
        ...
        {chimneyType === 'bands' && (
          <>
            <SegmentedControl
              ...
              options={[
                { label: '无', value: 'none' },
                { label: '单扇', value: 'single' },
                { label: '双扇', value: 'double' },
              ]}
