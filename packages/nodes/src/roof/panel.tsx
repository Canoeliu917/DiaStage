        ...
        <div className="flex flex-col gap-1">
          {segments.map((seg, i) => (
            <button
              ...
              type="button"
            >
              <span className="truncate">{seg.name || `屋面 ${i + 1}`}</span>
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-1">
            {chimneys.map((chimney, i) => (
              <button
                ...
                type="button"
              >
                <span className="truncate">{chimney.name || `烟囱 ${i + 1}`}</span>
                <span className="text-muted-foreground text-xs">烟囱</span>
              </button>
            ))}
            <ActionGroup>
              <ActionButton
          ...
          <div className="flex flex-col gap-1">
            {dormers.map((dormer, i) => (
              <button
                ...
                type="button"
              >
                <span className="truncate">{dormer.name || `老虎窗 ${i + 1}`}</span>
                <span className="text-muted-foreground text-xs">老虎窗</span>
              </button>
            ))}
            <ActionGroup>
              <ActionButton
          ...
          <div className="flex flex-col gap-1">
            {skylights.map((skylight, i) => (
              <button
                ...
                type="button"
              >
                <span className="truncate">{skylight.name || `天窗 ${i + 1}`}</span>
                <span className="text-muted-foreground text-xs">天窗</span>
              </button>
            ))}
            <ActionGroup>
              <ActionButton
          ...
          <div className="flex flex-col gap-1">
            {solarPanels.map((panel, i) => (
              <button
                ...
                type="button"
              >
                <span className="truncate">{panel.name || `光伏板 ${i + 1}`}</span>
                <span className="text-muted-foreground text-xs">光伏板</span>
              </button>
            ))}
            <ActionGroup>
              <ActionButton
          ...
          <div className="flex flex-col gap-1">
            ...
            <SegmentedControl<'box-vent' | 'ridge-vent' | 'turbine-vent'>
              ...
              options={[
                { label: '箱式', value: 'box-vent' },
                { label: '屋脊', value: 'ridge-vent' },
                { label: '涡轮', value: 'turbine-vent' },
              ]}
              value={ventType}
            />
            <ActionGroup>
          ...
          <div className="flex flex-col gap-1">
            {gutters.map((gutter, i) => (
              <button
                ...
                type="button"
              >
                <span className="truncate">{gutter.name || `檐沟 ${i + 1}`}</span>
                <span className="text-muted-foreground text-xs">檐沟</span>
              </button>
            ))}
            <ActionGroup>
              <ActionButton
