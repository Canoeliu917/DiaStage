...
export const eyebrowVentDefinition: NodeDefinition<typeof EyebrowVentNode> = {
  ...
  capabilities: {
    slots: () => [
      { slotId: 'hood', label: '罩壳', default: 'library:preset-softwhite' },
      { slotId: 'front', label: '百叶', default: 'library:preset-softwhite' },
    ],
  ...
  toolHints: [
    { key: '鼠标左键', label: '在屋顶放置眉形通风口' },
    { key: 'Esc', label: '取消' },
  ],

  presentation: {
    label: '眉形通风口',
    description: '前侧带百叶的低矮弧形屋顶通风口。',
