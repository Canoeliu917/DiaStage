...
export function SlabPanel() {
  ...
  const elevationPresets =
    unit === 'imperial'
      ? [
          { label: '下沉（6 英寸）', elevation: -0.1524 },
          { label: '薄（1 英寸）', elevation: 0.0254 },
          { label: '标准（2 英寸）', elevation: 0.0508 },
          { label: '厚（6 英寸）', elevation: 0.1524 },
        ]
      : [
          { label: '下沉（15 厘米）', elevation: -0.15 },
          { label: '薄（2 厘米）', elevation: 0.02 },
          { label: '标准（5 厘米）', elevation: 0.05 },
          { label: '厚（15 厘米）', elevation: 0.15 },
        ]
