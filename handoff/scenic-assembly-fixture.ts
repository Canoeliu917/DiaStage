...
const specs=[['wall-a','SCN-FLAT-090',[-1.5,0,0],0],['wall-b','SCN-FLAT-090',[0,0,0],0],['wall-c','SCN-FLAT-090',[1.7,0,0],Math.PI/2],['wall-d','SCN-FLAT-090',[-2.8,0,0],Math.PI/2],['window','SCN-WIN-130',[2.8,0,1.5],0],['door','SCN-DOOR-130',[1.8,0,1.5],0],['bi','SCN-FOLD-02',[-1,0,-1.5],0],['tri','SCN-FOLD-03',[1.5,0,-1.5],0]] as const
